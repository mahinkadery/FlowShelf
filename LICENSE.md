...
FlowShelf is **source-available, not open-source**. The code is public so you can
read it, learn from it, and contribute — but you may **not redistribute, sell, or
ship your own copy** of the app. It is licensed under the **PolyForm Strict
License 1.0.0** (full text below).

- ✅ View the source, study it, and run it for personal/noncommercial use
- ✅ Fork and modify **solely to prepare a contribution** back to this repository
  (see [CONTRIBUTING.md](CONTRIBUTING.md))
- ❌ Distribute the app or builds of it
- ❌ Make and ship derivative/new works based on it
- ❌ Any commercial use

The names **"FlowShelf"** and the FlowShelf icon/logo are trademarks of the
licensor and are **not** covered by this license — even a permitted build may not
be distributed under the FlowShelf name or icon.

Required Notice: Copyright © 2026 Mahin Kadery (FlowShelf)
